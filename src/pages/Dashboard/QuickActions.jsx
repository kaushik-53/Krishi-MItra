    ...
    return (<Card className="h-full">
      ...
      <div className="grid grid-cols-2 gap-3">
        {actions.map((action) => {
            ...
            return (<button key={action.label} onClick={() => navigate(action.route)} className="flex flex-col items-center gap-2 p-4 rounded-2xl bg-surface-2/50 border border-glass-border hover:border-primary-400/30 hover:bg-surface-3 transition-all group">
