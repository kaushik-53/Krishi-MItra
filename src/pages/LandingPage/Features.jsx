...
export default function Features() {
    ...
    return (<section className="py-24 relative" id="features">
      <Container size="lg" clean>
        ...
        <motion.div variants={staggerContainer} initial="initial" whileInView="animate" viewport={{ once: true, margin: '-50px' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => {
            ...
            return (<motion.div key={feature.key} variants={fadeInUp} whileHover={{ y: -8, transition: { duration: 0.3 } }} className="glass-card p-6 group cursor-pointer">
                {/* Icon container */}
