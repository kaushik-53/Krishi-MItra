...
export default function HowItWorks() {
    ...
    return (<section className="py-24 bg-surface-1/50" id="how-it-works">
      <Container size="lg" clean>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            return (<motion.div key={step.key} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.2, duration: 0.5 }} className="text-center">
