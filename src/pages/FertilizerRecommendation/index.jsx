...
import { fertilizerInputSchema } from '@/lib/validators';
      ...
      <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {['low', 'medium', 'high'].map((b) => (<label key={b} className="flex-1">
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-3 space-y-4">
            {recommendation ? (<Card className="h-full">
               ...
               </Card>) : (<Card className="flex flex-col items-center justify-center py-16 text-center h-full">
