...
export default function Footer() {
    ...
    return (<footer className="border-t border-glass-border bg-surface-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              {[ExternalLink, MessageSquare, Globe, Mail].map((Icon, i) => (<a key={i} href="#" className="p-2 rounded-lg bg-surface-1 border border-glass-border text-text-muted hover:text-primary-400 hover:border-primary-400/30 transition-all" aria-label="Social link">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['ICAR Guidelines', 'KVK Directory', 'PM-KISAN', 'eNAM Portal'].map((item) => (<li key={item}>
