      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-1.5 w-36 glass rounded-xl p-1 border border-glass-border shadow-xl z-50"
          >
            <button
              onClick={() => selectLanguage('en')}
              className={`flex items-center justify-between w-full px-3 py-2 text-xs rounded-lg font-medium transition-colors ${
                language === 'en'
